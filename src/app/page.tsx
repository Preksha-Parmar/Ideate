      ...
      <div className="">
        ...
        <div className="pt-20 text-center">
          <div>
            <h1 className="text-6xl font-bold">
              Turn your <span className="text-amber-300">idea</span> into
            </h1>
            <h1 className="text-6xl font-bold">
              a <span className="text-amber-300">plan</span> with{" "}
              <span className="text-amber-300">1 click</span>
            </h1>
          </div>
          <div className=" pt-4">
            <h6 className=" text-xl text-muted-foreground">
              Ideate is a platform that suggests marketing strategies,
            </h6>
            <h6 className=" text-xl text-muted-foreground">
        ...
        <div className=" bg-blue-100 py-16 ">
          <div className="mx-auto max-w-screen-xl">
            ...
            <LargeHeading text="Built with Ideate" />
